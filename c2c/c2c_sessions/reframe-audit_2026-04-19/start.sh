#!/bin/bash
# C2C launcher — reframe audit session.
...
REFRAME_SCRIPT="/Users/june/Documents/GitHub/Reframe/reframe_bootstrap.py"
...
# Generate reframe context once at session launch
echo "Generating reframe context (allow ~90s for Ollama timeouts)..."
...
echo "Reframe audit session started."
