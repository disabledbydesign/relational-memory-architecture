#!/bin/bash
# C2C launcher — foundation build session.
# Clean shutdown via signal traps so stop.sh doesn't leave orphan sleeps.

set -e

SESSION_DIR="/Users/june/Documents/GitHub/liberation_labs/c2c_sessions/foundation-build_2026-04-19"
...
echo "C2C foundation build session started."
